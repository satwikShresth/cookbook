...
import { searchStore, setQuery, addTag, removeTag, clearSearch } from '#/utils/search'
  ...
  return (
    <Box fontSize={uiSize} >
      <Combobox.Root
        ...
        borderRadius="md"
        _focusWithin={{ borderColor: 'colorPalette.500', shadow: '0 0 0 2px var(--chakra-colors-colorPalette-200)' }}
